...
checkpoint = ModelCheckpoint('CNN_EA-LSTM_best_model.h5', monitor='val_loss', save_best_only=True)
...
# 加载最佳模型
best_model = load_model('CNN_EA-LSTM_best_model.h5', custom_objects={'AttentionLayer': AttentionLayer})
...
# 绘制最近一个月的实际值与预测值对比图
last_month_predictions = y_pred_rescaled
plt.figure(figsize=(12, 6))
plt.plot(last_month_predictions, color = 'r')
plt.legend()
plt.show()
